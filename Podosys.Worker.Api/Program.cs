...
builder.Services.AddTransient<IProcedurePriceTableReport, ProcedurePriceTableReport>();
...
//builder.Services.AddCronJob<TimerProcedurePriceTableReport>(c => { c.CronExpression = "0 05 * * *"; c.TimeZoneInfo = timeZoneBrasilia; });
